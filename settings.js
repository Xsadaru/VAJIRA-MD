...
global.owner = [process.env.OWNER_NUMBER] || ['94777366450'] // Owner number , (අයිතිකරුගේ නම්බර් එක )

module.exports = {    
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD:ClemencyQumar',
...
OWNER_NUMBER: process.env.OWNER_NUMBER || '94777366450'  ,    
ALIVE: process.env.ALIVE || `hi lassana lamayo`,
OWNER_NAME: process.env.OWNER_NAME || 'shadesha' ,     
